insert into users (id, login, hash_password, salt)
...
insert into accesses (id, user_id, resource, role)
values (1, 1, 'A.', 'READ'),
       (2, 1, 'A.AA.', 'WRITE'),
...
insert into user_sessions (id, start_date, end_date, volume, access_id)
values (1, '20200501', '20200502', 100, 1),
    (2, '20200502', '20200503', 300, 4),
    (3, '20200502', '20200503', 150, 4),
    (4, '20200512', '20200513', 500, 5),
    (5, '20200515', '20200516', 1000, 5);